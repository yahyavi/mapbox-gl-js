...
module.exports = renderColorRamp;

const RGBAImage = require('./image').RGBAImage;
 ...
 * @private
 */
function renderColorRamp(expression: StylePropertyExpression, colorRampEvaluationParameter: string): RGBAImage {
